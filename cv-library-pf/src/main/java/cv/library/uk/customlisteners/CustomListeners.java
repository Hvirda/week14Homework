package cv.library.uk.customlisteners;
...
import static cv.library.uk.utility.Utility.takeScreenShot;
...
//        Reporter.log("<a target = \"_blank\" href="+screenshotName+"><img src="+screenshotName+" height=200 width=200></img></a>");
    ...
    public void onStart(ITestContext iTestContext) {
        ...
        reporter.config().setReportName("cv-library"); // please change my name to current project name before you submit, else goo luck----
